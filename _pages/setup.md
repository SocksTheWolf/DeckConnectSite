...
{% img lazy priority style="max-width: 472px" src='/assets/images/setup/unreal/ProjectSettings.png' alt='Opening Project Settings' wrapper_class="center halfsize" %}
...
{% img lazy style="max-width: 1259px" src='/assets/images/setup/unreal/DeckConnectSettings.png' alt='Viewing DeckConnect Settings' wrapper_class="center" %}
...
{% img lazy style="max-width: 798px" src='/assets/images/setup/unreal/NewAction.png' alt='Creating a new action' wrapper_class="center" %}
...
{% img lazy style="max-width: 821px" src='/assets/images/setup/unreal/FindDeckNode.png' alt='Finding the DeckConnect Widget' wrapper_class="center" %}  

{:start="4"}
4. In the widget that appears, use the `Action Name` option to find the action you just created in the previous step.

{% img lazy style="max-width: 337px" src='/assets/images/setup/unreal/ActionNameList.png' alt='Action Name List' wrapper_class="center halfsize" %}

{:start="5"}
5. On the action pin, drag the pin to create a New Node. In the menu that appears, click `Add Event` and then `Add Custom Event`.

{% img lazy style="max-width: 544px" src='/assets/images/setup/unreal/AddCustomEvent.png' alt='Adding a new Custom Event' wrapper_class="center halfsize" %}  
...
{% img lazy style="max-width: 872px" src='/assets/images/setup/unreal/Output.png' alt='Final Blueprint Graph' wrapper_class="center" wrapper_style="width: 75%" %}  

{:start="7"}
7. Now whenever the user presses the button, they'll will be presented with the message "Hello"!  

{% img lazy style="max-width: 353px" src='/assets/images/setup/unreal/Result.png' alt='Output upon pressing button' wrapper_class="center halfsize" %}  
...
{% img lazy style="max-width: 844px" src='/assets/images/setup/deck/CreateANewAction.png' alt='Creating a new Stream Deck button' wrapper_class="center halfsize" %}
...
{% img lazy style="max-width: 824px" src='/assets/images/setup/deck/InstanceSettings.png' alt='Highlighted box around Instance Settings' wrapper_class="center halfsize" %}
...
{% img lazy style="max-width: 568px" src='/assets/images/setup/deck/InstanceManagement.png' alt='Managing Instances' wrapper_class="center halfsize" %}
...
{% img lazy style="max-width: 561px" src='/assets/images/setup/deck/ActionListExample.png' alt='Actions List Example' wrapper_class="center halfsize" %}
