...
{% img lazy style="max-width: 584px" src='/assets/images/reference/GetDeckConnectSubsystem.png' alt='Getting the Subsystem' wrapper_class="center halfsize" %}
...
{% img lazy style="max-width: 706px" src='/assets/images/reference/RegisterFunction.png' alt='Registering Functions' wrapper_class="center halfsize" %}
...
{% img lazy style="max-width: 625px;" src='/assets/images/reference/PluginDownloadWidget.png' wrapper_class="center" alt='Search for DeckConnect to find this faster' wrapper_style="width: 75%" %}
...
{% img lazy style="max-width: 624px" src='/assets/images/reference/Disconnect.png' alt='Calling Disconnect to Stream Deck' wrapper_class="center" wrapper_style="width: 75%" %}
...
{% img lazy style="max-width: 842px" src='/assets/images/reference/IsConnected.png' alt='Calling IsConnected to Stream Deck' wrapper_class="center" wrapper_style="width: 75%" %}
...
{% img lazy style="max-width: 1272px" src='/assets/images/reference/GetGUIDForName.png' alt='Getting an Action GUID for the given Name' wrapper_class="center" wrapper_style="width: 75%" %}
...
{% img lazy style="max-width: 1180px;" src='/assets/images/reference/GetNameForGUID.png' alt='Getting an Action Name for the given GUID' wrapper_class="center" wrapper_style="width: 75%" %}
...
{% img lazy style="max-width: 1231px" src='/assets/images/reference/DoesActionExist.png' alt='Getting if an Action exists' wrapper_class="center" wrapper_style="width: 75%" %}
