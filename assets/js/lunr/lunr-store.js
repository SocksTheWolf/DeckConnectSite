    ...
    {%- for doc in docs -%}
      ...
      {%- endif -%}
      {
        ...
        "excerpt":
          ...
          {%- elsif doc.search_lite == true -%}
            {{ doc.excerpt | strip | jsonify }},
          {%- else -%}
            {{ doc.content | newline_to_br |
              replace:"<br />", " " |
              replace:"</p>", " " |
    ...
    "excerpt":
        ...
        {%- else -%}
          {{ doc.content | newline_to_br |
            ...
            replace:"</h5>", " " |
            replace:"</h6>", " "|
          liquify | strip_html | strip_newlines | strip | truncatewords: 50 | jsonify }},
        {%- endif -%}
      "url": {{ doc.url | absolute_url | replace: 'index.html', '' | jsonify }}
  }{%- unless forloop.last and l -%},{%- endunless -%}
  {%- endfor -%}
{%- endif -%}]
